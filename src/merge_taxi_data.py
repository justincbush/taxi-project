...
for argument in sys.argv[1:]:
    ...
    print 'took', (time.clock() - local_start)*3600, 'seconds'
    local_start = time.clock()
    ...
    print 'total of', (time.clock() - global_start)*3600, 'seconds so far'
    ...
    print 'total of', (time.clock() - global_start)*3600, 'seconds'
